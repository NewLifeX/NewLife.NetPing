# NewLife.NetPing - 设备网络心跳

![GitHub top language](https://img.shields.io/github/languages/top/newlifex/NewLife.NetPing?logo=github)
![GitHub License](https://img.shields.io/github/license/newlifex/NewLife.NetPing?logo=github)
![Nuget Downloads](https://img.shields.io/nuget/dt/NewLife.NetPing?logo=nuget)
![Nuget](https://img.shields.io/nuget/v/NewLife.NetPing?logo=nuget)
![Nuget (with prereleases)](https://img.shields.io/nuget/vpre/NewLife.NetPing?label=dev%20nuget&logo=nuget)

IoT驱动，通过Ping探测到目标设备的网络情况，并收集延迟数据  

源码： https://github.com/NewLifeX/NewLife.NetPing  
Nuget：NewLife.NetPing  
